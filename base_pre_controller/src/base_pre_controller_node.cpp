...
double max_vx = 0.10, max_vth = 0.1;
...
{
    ros::init(argc, argv, "base_pre_controller");
    ROS_INFO("base_pre_controller running!");

    ros::NodeHandle n;
    std_msgs::Int32 motor1, motor2;
    double vr1, vr2;

    ros::Subscriber s1 = n.subscribe("/cmd_vel_output", 500, cmd_vel_Callback);
